...
namespace ProyectoLinkedinMVC.Controllers
{
    public class ConexionController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> Put(FormDataCollection form)
        {
            ...
            var respuestaEmpresa = await GetAsync(apiUrlGetConexion = "https://localhost:44345/api/Conexion/" + key);
            Conexion conexion = JsonConvert.DeserializeObject<Conexion>(respuestaEmpresa);
