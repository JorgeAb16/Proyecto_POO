...
namespace ProyectoLinkedinMVC.Controllers
{
    public class UsuarioEmpresaController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> Get(DataSourceLoadOptions loadOptions)
        {
            ...
            List<Usuario_Empresarial> listaUsuarioEmpresarial = JsonConvert.DeserializeObject<List<Usuario_Empresarial>>(respuestaJson);
            return Request.CreateResponse(DataSourceLoader.Load(listaUsuarioEmpresarial, loadOptions));
        }
